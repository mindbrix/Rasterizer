...
struct RasterizerTest {
    static void addTestScenes(Ra::SceneList& list) {
        ...
        if (0) {
            ...
            Ra::Path quadPath;  quadPath.ref->moveTo(0, 0), quadPath.ref->quadTo(0, 50, 100, 100), quadPath.ref->quadTo(100, 90, 0, 0);
            ...
            scene.addPath(quadPath, Ra::Transform(), black, 100.f, 0);
        }
        if (0) {
