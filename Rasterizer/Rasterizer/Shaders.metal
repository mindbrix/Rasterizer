                                        ...
                                        uint vid [[vertex_id]], uint iid [[instance_id]])
{
    ...
    float tx, ty, ma, mb, mc, md, x16, y16, px, py, x, y, nx, ny, ax, ay, rl, npx, npy, nnx, nny, tdot, tanx, tany, rcos, miter, twist = 1.0;
    ...
    for (int vid = 0; vid < kFastSegments; vid++, px = x, py = y, x = nx, y = ny) {
        ...
        miter = twist * min(rcos, kP16MiterLimit) / kP16MiterLimit * 32767.0;
