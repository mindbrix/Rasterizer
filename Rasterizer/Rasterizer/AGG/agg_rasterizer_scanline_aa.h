...
namespace agg
{
    ...
    //------------------------------------------------------------------------
    template<class Clip> 
    void rasterizer_scanline_aa<Clip>::clip_box(float x1, float y1, float x2, float y2)
    {
        reset();
    ...
    //------------------------------------------------------------------------
    template<class Clip>
    void rasterizer_scanline_aa<Clip>::enable_clipping()
    {
        m_clipper.enable_clipping();
    }
    //------------------------------------------------------------------------
    template<class Clip>
    void rasterizer_scanline_aa<Clip>::disable_clipping()
    {
    ...
    //------------------------------------------------------------------------
    template<class Clip>
    void rasterizer_scanline_aa<Clip>::move_to(float x, float y)
    {
    ...
    //------------------------------------------------------------------------
    template<class Clip>
    void rasterizer_scanline_aa<Clip>::line_to(float x, float y)
    {
    ...
    //------------------------------------------------------------------------
    template<class Clip>
    void rasterizer_scanline_aa<Clip>::last(float x, float y)
    {
        m_clipper.last(m_outline,
                          conv_type::upscale(x),
                          conv_type::upscale(y));
        m_status = status_line_to;
    }
