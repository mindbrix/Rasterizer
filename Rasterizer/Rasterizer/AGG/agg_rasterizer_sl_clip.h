...
namespace agg
{
    ...
    struct ras_conv_int
    {
        ...
        AGG_INLINE static int upscale(float v)  { return iround(v * poly_subpixel_scale); }
    ...
    public:
        ...
        rect_type clip_box() const  { return m_clip_box; }
...
//                ras.line(Conv::xi(m_x1), Conv::yi(m_y1), Conv::xi(x2), Conv::yi(y2));
        ...
        //--------------------------------------------------------------------
        template<class Rasterizer>
        void last(Rasterizer& ras, coord_type x2, coord_type y2) {
            m_x1 = x2;  m_y1 = y2;
            m_f1 = clipping_flags(x2, y2, m_clip_box);
        }
    ...
    typedef rasterizer_sl_clip<ras_conv_float>   rasterizer_sl_clip_float;
