...
struct Rasterizer {
    ...
    struct GPU {
        ...
        struct Allocator {
            ...
            void allocAndCount(float lx, float ly, float ux, float uy, size_t idx, size_t edgeInstances, size_t fastEdgeInstances, size_t fastInstances, size_t quadInstances, Cell *cell) {
    ...
    struct Buffer {
        ...
        enum Type { kEdges, kFastWindingEdges, kFastEdges, kQuadEdges, kOpaques, kInstances };
        struct Entry {
                        ...
                        if (clip.lx != clip.ux && clip.ly != clip.uy) {
                            ...
                            if (width == 0.f && clip.uy - clip.ly <= kMoleculesHeight && clip.ux - clip.lx <= kMoleculesHeight) {
                                ...
                                if (width) {
                                    ...
                                    bool fast = det * g->maxDot < 16.f || (g->counts[Geometry::kQuadratic] == 0 && g->counts[Geometry::kCubic] == 0);
