...
struct RasterizerState {
    ...
    enum KeyCode { kC = 8, kF = 3, kI = 34, kJ = 38, kL = 37, kO = 31, kP = 35, k1 = 18, k0 = 29, kReturn = 36 };
    struct Event {
    ...
    bool writeEvent(Event e) {
        const KeyCode keyCodes[] = { kC, kF, kI, kJ, kO, kP, k0, k1, kL, kReturn };
            ...
            switch(e.type) {
                ...
                case Event::kKeyDown:
                    ...
                    if (e.keyCode == KeyCode::k1)
                        ...
                        opaque = !opaque;
                    else if (e.keyCode == KeyCode::kJ)
                        p16Outlines = !p16Outlines;
    ...
    bool keyDown = false, mouseDown = false, mouseMove = false, useCurves = true, animating = false, opaque = false, fastOutlines = true, p16Outlines = false;
